...
| Tablas SAP estimadas | 24–31 | `docs/propuesta_final/ANEXO_TECNICO_TRANSACCIONES_VS_TABLAS.md` | Rango optimizado por Universal Journal + robustez logística, CO-PA (Costing-Based) y textos. |
