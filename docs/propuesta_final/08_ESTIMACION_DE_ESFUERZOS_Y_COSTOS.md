...
**Rango canónico de tablas SAP (MVP): 32–38 tablas** (32 núcleo + hasta 6 condicionales; optimizado por uso de ACDOCA/ACDOCA_T que reemplaza tablas históricas BSEG, COEP, FAGLFLEXA).
